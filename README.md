...
straight-forward as it is obvious: [HelloController](https://github.com/rthway/docker-spring-boot-java-web-service/blob/master/src/main/java/com/levo/dockerexample/controller/HelloController.java)
...
The reason we are doing so is, we need to reference the **.jar** file in the [Dockerfile](https://github.com/rthway/docker-spring-boot-java-web-service/blob/master/Dockerfile);
...
In our example, you will see the properties as below in the [pom.xml](https://github.com/rthway/docker-spring-boot-java-web-service/blob/master/pom.xml) file.
...
to do that, we use define the **final name** under **build** section of our [pom.xml](https://github.com/rthway/docker-spring-boot-java-web-service/blob/master/pom.xml) file as below;
...
we are all set and we can write the [Dockerfile](https://github.com/rthway/docker-spring-boot-java-web-service/blob/master/Dockerfile).
...
Now our [Dockerfile](https://github.com/rthway/docker-spring-boot-java-web-service/blob/master/Dockerfile) is all set, we can directly build the image.
...
<p align="center">
	<img src="https://github.com/rthway/docker-spring-boot-java-web-service/blob/master/screenshots/00_docker_test.PNG" alt="docker-web-test">
</p>
